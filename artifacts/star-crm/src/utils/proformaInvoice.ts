...
const REGION_CONFIGS: Record<string, RegionConfig> = {
  ...
  EGYPT: {
    ...
    companySubTitle: "Industrial Sewing Machines &amp; Garment Equipment",
    letterheadContact: "Egypt<br>Email : star@starsew.com",
    bank: [
      { key: "Bank Name",      value: "—" },
    ...
    paymentText: "100% Advance",
    noteText: "Customer must provide local expenses including delivery and off-loading charges.",
  ...
  GHANA: {
    ...
    companySubTitle: "Industrial Sewing Machines &amp; Garment Equipment",
    letterheadContact: "Ghana<br>Email : star@starsew.com",
    bank: [
      { key: "Bank Name",      value: "—" },
      { key: "Account Number", value: "—" },
  ...
  ETHIOPIA: {
    ...
    companySubTitle: "Industrial Sewing Machines &amp; Garment Equipment",
    letterheadContact: "Ethiopia<br>Email : star@starsew.com",
    bank: [
      { key: "Bank Name",      value: "—" },
      { key: "Account Number", value: "—" },
