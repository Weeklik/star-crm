...
export function generateProformaInvoiceHtml(data: ProformaInvoiceData): string {
  ...
  const COUNTRY_SPECIFIC_BANKS: Record<string, BankRow[]> = {
    "TN-EUR-ATB": [
      { key: "Beneficiary Account Name:", value: "STAR NORTH AFRICA" },
      { key: "Account Number:",           value: "01 097 1311121009234 85" },
      { key: "IBAN (23 Chars):",          value: "TN59 0109 7131 1121 0092 3485" },
      { key: "Currency:",                 value: "EUR" },
      { key: "Bank Name:",                value: "ARAB TUNISIAN BANK" },
      { key: "Branch:",                   value: "AGENCE SAADI 1 - TUNIS - TUNISIA" },
      { key: "Swift:",                    value: "ATBKTNTTXXX" },
    ],
    "TN-EUR-UIB": [
      { key: "Beneficiary Account Name:", value: "STAR NORTH AFRICA" },
      { key: "Account Number:",           value: "12 103 000 0055001980 04" },
      { key: "IBAN (23 Chars):",          value: "TN 59 12 103 000 0055001980 04" },
      { key: "Currency:",                 value: "EUR" },
      { key: "Bank Name:",                value: "UNION INTERNATIONALE DE BANQUES" },
      { key: "Branch:",                   value: "TUNIS - TUNISIA" },
      { key: "Swift:",                    value: "UIBKTNTTXXX" },
    ],
    "TN-EUR-TIB": [
      { key: "Beneficiary Account Name:", value: "STAR NORTH AFRICA" },
      { key: "Account Number:",           value: "0202/0435347/003/4410/000" },
      { key: "IBAN (23 Chars):",          value: "TN59 7300 0043 5347 0340 0028" },
      { key: "Currency:",                 value: "EUR" },
      { key: "Bank Name:",                value: "TUNIS INTERNATIONAL BANK" },
      { key: "Branch:",                   value: "0202 MAIN BRANCH - TUNIS - TUNISIA" },
      { key: "Swift:",                    value: "TUIBTNTTXXX" },
    ],
    "KEN-KES": [
      { key: "Beneficiary Account Name:", value: "STAR SEWING MACHINES (K) LIMITED" },
      { key: "Account Number:",           value: "11474799421" },
      { key: "IBAN (23 Chars):",          value: "N/A" },
      { key: "Currency:",                 value: "KES" },
      { key: "Bank Name:",                value: "KCB BANK" },
      { key: "Branch:",                   value: "RIVER ROAD BRANCH - NAIROBI - KENYA" },
      { key: "Swift:",                    value: "KCBLKENXXXX" },
    ],
    "KEN-USD": [
      { key: "Beneficiary Account Name:", value: "STAR SEWING MACHINES (K) LIMITED" },
    ...
    "NIG-NGN": [
      { key: "Beneficiary Account Name:", value: "STAR SEWING MACHINES LIMITED" },
      { key: "Account Number:",           value: "1014350646" },
      { key: "IBAN (23 Chars):",          value: "N/A" },
      { key: "Currency:",                 value: "NGN" },
      { key: "Bank Name:",                value: "ZENITH BANK PLC" },
      { key: "Branch:",                   value: "CREEK ROAD BRANCH - LAGOS - NIGERIA" },
      { key: "Swift:",                    value: "ZEIBNGLAXXX" },
    ],
    "NIG-USD": [
      { key: "Beneficiary Account Name:", value: "STAR SEWING MACHINES LIMITED" },
    ...
    "KSA-SAR": [
      { key: "Beneficiary Account Name:", value: "YOUSEF AMER BAQURAYN ALHADHRAMI TRADING EST" },
      { key: "Account Number:",           value: "1861423539940" },
      { key: "IBAN (23 Chars):",          value: "SA6520000001861423539940" },
      { key: "Currency:",                 value: "SAR" },
      { key: "Bank Name:",                value: "RIYADH BANK" },
      { key: "Branch:",                   value: "186 HERAA BRANCH - JEDDAH - KSA" },
      { key: "Swift:",                    value: "RIBLSARIXXX" },
    ],
    "GHA-GHS": [
      { key: "Beneficiary Account Name:", value: "STAR GLOBAL MACHINERY" },
      { key: "Account Number:",           value: "6010625726" },
      { key: "IBAN (23 Chars):",          value: "N/A" },
      { key: "Currency:",                 value: "GHS" },
      { key: "Bank Name:",                value: "ZENITH BANK" },
      { key: "Branch:",                   value: "KOJO THOMAS BRANCH - ACCRA - GHANA" },
      { key: "Swift:",                    value: "ZEBLGHAC" },
    ],
  };
